...
import { useRelinkValue_BASE_UNSTABLE } from '../use-relink-value-unstable'
 ...
 * @public
 */
export function useRelinkState_UNSTABLE<S>(
 ...
 * @public
 */
export function useRelinkState_UNSTABLE<S, K>(
  source: RelinkSource<S>,
...
export function useRelinkState_UNSTABLE<S, K>(
  ...
  const state = useRelinkValue_BASE_UNSTABLE(scopedSource, selector)
